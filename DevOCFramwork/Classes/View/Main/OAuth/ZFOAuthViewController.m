...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] init:@"自动填充" fontSize:16 image:nil horizontalAlignment:UIControlContentHorizontalAlignmentRight target:self action:@selector(autoFill)];
...
-(void) autoFill {
    NSString *js = @"document.getElementById('userId').value = '15806767487';document.getElementById('passwd').value = '58431691013';";
